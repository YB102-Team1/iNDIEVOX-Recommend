CREATE TABLE IF NOT EXISTS `test_set_4` (
...
ALTER TABLE `test_set_4` ADD PRIMARY KEY (`id`);
ALTER TABLE `test_set_4` MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1;