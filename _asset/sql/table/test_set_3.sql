CREATE TABLE IF NOT EXISTS `test_set_3` (
...
ALTER TABLE `test_set_3` ADD PRIMARY KEY (`id`);
ALTER TABLE `test_set_3` MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1;