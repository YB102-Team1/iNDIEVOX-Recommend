CREATE TABLE IF NOT EXISTS `test_set_0` (
...
ALTER TABLE `test_set_0` ADD PRIMARY KEY (`id`);
ALTER TABLE `test_set_0` MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1;