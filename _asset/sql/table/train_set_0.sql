CREATE TABLE IF NOT EXISTS `train_set_0` (
...
ALTER TABLE `train_set_0` ADD PRIMARY KEY (`id`);
ALTER TABLE `train_set_0` MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1;