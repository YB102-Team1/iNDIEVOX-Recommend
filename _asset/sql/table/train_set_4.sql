CREATE TABLE IF NOT EXISTS `train_set_4` (
...
ALTER TABLE `train_set_4` ADD PRIMARY KEY (`id`);
ALTER TABLE `train_set_4` MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1;