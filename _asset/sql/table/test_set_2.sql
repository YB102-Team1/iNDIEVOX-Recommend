CREATE TABLE IF NOT EXISTS `test_set_2` (
...
ALTER TABLE `test_set_2` ADD PRIMARY KEY (`id`);
ALTER TABLE `test_set_2` MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1;